...
/*
    Overview:
    This script implements a 3D dungeon generator that uses Delaunay triangulation 
    to map out rooms and connect them with hallways.
    ...
    - Delaunay triangulation and related graph algorithms are adapted from 
...
public class Generator3D : MonoBehaviour
{
    ...
    /*
    PathfindHallways uses A* search algorithm on a 3D grid to route corridors between room centers chosen from Delaunay graph. 
    - Uses Euclidean heuristic, penalizes entering Room cells (+5), 
    - Slightly prefers digging through empty cells (+1), 
    - And heavily penalizes/validates vertical moves (+100 and 2×2 clearance checks) which become Stairs. 
    - Writes results into the grid andspawns hallway/stair prefabs accordingly
    */
    ...
    // edit these so that PlaceRoom, PlaceHallway, PlaceStairs, can refer to their own prefab
